#!/usr/bin/env python3
"""Generate per-org intel files for 2026-06-01 outreach batch.
...
TODAY = "2026-06-01"
OUTDIR = "/Users/victoria/.openclaw/workspace/crm/intelligence/2026-06-01"
...
# Verified-real escalation websites (probed 2026-06-01)
...
for o in orgs:
    ...
    if site_host in RESOLVED:
        ...
        site_status = "DID NOT RESOLVE on 2026-06-01 probe — likely dead/seed data, FLAG FOR DUNCAN"
    else:
